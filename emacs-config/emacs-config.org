...
Because of this, defer all Super bindings so they run after the [[superpocalypse]]
...
(Note that I don't have to protect these bindings from the [[superpocalypse]] because they're called by the terminal config itself, which can sequence things appropriately.)
...
Use [[https://github.com/pgroce/emacs-pkgs/blob/master/pg-sh.org][pg-sh]] to make using shells a little more pleasant. Defer it so the keybindings make it through the [[superpocalypse]]

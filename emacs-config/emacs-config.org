  ...
  (use-package org
    ...
    (progn
      (defun pg-org-interactive-todo ()
        (interactive)
        "Call `org-todo' with the results of a completing read on the
  current set of todo keywords."
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package elpy
    ...
    (progn
      ...
      (message "ELPY: Removed elpy-module-yasnippet from elpy modules")
      (if (load "flycheck" t t)
        ...
        (message "ELPY: Not loading flycheck"))))
#+END_SRC
